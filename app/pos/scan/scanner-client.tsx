...
export default function ScannerClient({ userEmail, userRole }: Props) {
...
try {
// Dynamic import — html5-qrcode only available in browser
...
// 1. Find product by barcode OR sku (allows manual SKU entry too)
...
// 3. Get all current pricing across channels
...
{userRole.toUpperCase()} · {userEmail}
</div>
</div>
</div>
</div>
...
{/* Action buttons (Edit + Adjust Stock will hook into Commit B) */}
<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginTop: 16 }}>
<button
disabled
title="Coming in Commit B"
