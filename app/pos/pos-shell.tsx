  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#f4f6f9', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <div className="bsc-mobile-topbar" style={{ display: 'none' }}>
        <button onClick={() => setMobileOpen(true)} style={{ background: 'none', border: 'none', color: '#fff', fontSize: 24, cursor: 'pointer', padding: 8 }}>☰</button>
      ...
      >
        <div style={{ padding: '20px 18px 16px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <button onClick={() => setMobileOpen(false)} className="bsc-mobile-close" style={{ display: 'none', background: 'none', border: 'none', color: '#fff', fontSize: 24, cursor: 'pointer' }}>×</button>
          </div>
        </div>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', padding: '14px 18px' }}>
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.6)', marginBottom: 2 }}>{user.email}</div>
      ...
      {mobileOpen && (
        <div onClick={() => setMobileOpen(false)} className="bsc-mobile-overlay" style={{ display: 'none' }} />
      )}
