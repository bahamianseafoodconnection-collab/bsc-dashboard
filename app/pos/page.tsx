...
function POSLayout({ children, showWaPanel, setShowWaPanel }: { children: React.ReactNode; showWaPanel: boolean; setShowWaPanel: (v: boolean) => void }) {
  return (
