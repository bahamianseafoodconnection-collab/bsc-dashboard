      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            ...
            <p style={{ margin: 0, color: '#25d36699', fontSize: 11 }}>+1 (242) 359-0285</p>
          </div>
        </div>
        <div style={{ display: 'flex', gap: 6 }}>
          <button
            onClick={() => setWaTab('web')}
            style={{
              padding: '5px 10px', borderRadius: 8, border: 'none', cursor: 'pointer',
              backgroundColor: waTab === 'web' ? '#25d366' : 'rgba(255,255,255,0.1)',
              color: waTab === 'web' ? '#000' : '#fff', fontWeight: 'bold', fontSize: 11,
            }}
          >
            Web
          </button>
          <button
            ...
            style={{
              padding: '5px 10px', borderRadius: 8, border: 'none', cursor: 'pointer',
              backgroundColor: waTab === 'qr' ? '#25d366' : 'rgba(255,255,255,0.1)',
              color: waTab === 'qr' ? '#000' : '#fff', fontWeight: 'bold', fontSize: 11,
            }}
          >
            QR
          </button>
      ...
      {waTab === 'qr' && (
        <div style={{ padding: 20, textAlign: 'center', flex: 1 }}>
          <p style={{ margin: '0 0 16px', color: '#aaa', fontSize: 13 }}>
            Scan to open BSC WhatsApp on your phone
          </p>
          {/* QR code via Google Charts API */}
          <img
            src="https://chart.googleapis.com/chart?chs=200x200&cht=qr&chl=https%3A%2F%2Fapi.whatsapp.com%2Fsend%3Fphone%3D12423590285&choe=UTF-8"
            alt="BSC WhatsApp QR"
            style={{ width: 200, height: 200, borderRadius: 12, backgroundColor: '#fff', padding: 8 }}
          />
          <p style={{ margin: '16px 0 8px', color: '#25d366', fontWeight: 'bold', fontSize: 14 }}>
            +1 (242) 359-0285
          </p>
          <p style={{ margin: '0 0 16px', color: '#4a5568', fontSize: 12 }}>
            Customers scan to WhatsApp BSC directly
          </p>
          ...
          <a
            ...
            style={{
              display: 'block', backgroundColor: '#25d366', color: '#000',
          ...
          <a
            ...
            rel="noopener noreferrer"
            style={{
              display: 'block', backgroundColor: '#075e54', color: '#fff',
              fontWeight: 'bold', fontSize: 14, padding: '12px',
...
<div class="receipt">
  ...
  const CustomerInput = () => (
    <div style={card}>
      <p style={{ margin: '0 0 8px', color: '#6b7280', fontSize: 10, letterSpacing: 1 }}>
      ...
      {customerName && customerPhone ? (
        ...
        <>
          {customerName && !customerPhone && (
            <input placeholder="Phone / WhatsApp *" value={customerPhone}
              onChange={(e) => setCustomerPhone(e.target.value)} type="tel"
              autoComplete="off" style={{ ...inp, marginBottom: 0 }} />
          )}
  ...
  // ── LAYOUT WRAPPER — splits POS + WhatsApp on wide screens ──
  const POSLayout = ({ children }: { children: React.ReactNode }) => (
    <div style={{
      ...
      {/* WHATSAPP PANEL — desktop/tablet right side */}
      <div
        className="wa-panel-desktop"
        style={{
          width: 380,
          flexShrink: 0,
          backgroundColor: '#070e1d',
          borderLeft: '1px solid #25d36633',
      ...
      {/* MOBILE FLOATING WHATSAPP TOGGLE */}
      <button
        onClick={() => setShowWaPanel(!showWaPanel)}
        className="wa-toggle-mobile"
        style={{
          position: 'fixed',
          bottom: 80,
          right: 16,
      ...
      {/* MOBILE WHATSAPP DRAWER */}
      {showWaPanel && (
        <div
          className="wa-panel-mobile"
          style={{
            position: 'fixed',
            inset: 0,
            zIndex: 300,
      ...
      <style>{`
        @media (min-width: 900px) {
          ...
          .wa-panel-mobile { display: none !important; }
        }
      ...
      <div style={pg}>
        ...
        {paymentMethod === 'cash' && (
          <div style={card}>
            ...
            <input type="number" placeholder="Or enter amount..." value={cashGiven}
