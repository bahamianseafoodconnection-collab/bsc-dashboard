...
<p style={{ margin: 0, color: '#6b7280', fontSize: 11 }}>Share with customers to shop online · Delivery all Bahamas islands</p>
</div>
</div>
...
<Link href="/market" target="_blank" style={{ display: 'block', padding: '10px', borderRadius: 10, backgroundColor: '#f5c518', color: '#000', fontWeight: 'bold', fontSize: 13, textAlign: 'center', textDecoration: 'none' }}>
Open Market →
</Link>
<button onClick={() => setSection('orders')} style={{ padding: '10px', borderRadius: 10, backgroundColor: 'transparent', color: '#4ade80', fontWeight: 'bold', fontSize: 13, border: '1px solid #4ade80', cursor: 'pointer' }}>
📋 View Orders
</button>
</div>
</div>
...
{ s: 'orders' as Section, icon: '📋', label: 'Orders' },
