...
export default function MarketPage() {
  ...
  const allProducts = [
    ...
    ...supplierProducts.map(sp => ({
      ...
      image:        sp.photo_url || "https://images.unsplash.com/photo-1534482421-64566f976cfa?w=400&q=80",
            ...
            myOrders.map(order => {
              ...
              return (
                <div key={order.id} style={{ backgroundColor: "#0d1f3c", borderRadius: 16, padding: "16px", border: "1px solid #1e3a5f", marginBottom: 14 }}>
                  ...
                  <div style={{ height: 3, backgroundColor: "#1e3a5f", borderRadius: 3, overflow: "hidden", marginBottom: 14 }}>
                    <div style={{ height: "100%", borderRadius: 3, backgroundColor: "#4ade80", width: order.status === "pending" ? "10%" : order.status === "confirmed" ? "30%" : order.status === "packing" ? "55%" : order.status === "out_for_delivery" ? "80%" : "100%" }} />
                  </div>
