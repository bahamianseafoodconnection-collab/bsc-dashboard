      ...
      <div style={{ minHeight: '100vh', backgroundColor: '#fff', overflowX: 'hidden' }}>
            ...
            <div style={{ display: 'flex', gap: 2, alignItems: 'center' }}>
              {[
                ...
                <button
                  ...
                  style={{ background: 'none', border: 'none', color: i === 0 ? '#f5a623' : '#cbd5e1', fontSize: 14, cursor: 'pointer', padding: '6px 12px', borderRadius: 6, fontWeight: i === 0 ? 700 : 500 }}
                >
                  {item.label}
                </button>
              ))}
        ...
        <div style={{
          ...
          <div style={{ position: 'absolute', top: '50%', left: '8%', transform: 'translateY(-50%)', maxWidth: 560, zIndex: 2 }}>
            ...
            <div className="fade-up-4" style={{ display: 'flex', gap: 14, flexWrap: 'wrap' }}>
              <button className="btn-gold" onClick={() => router.push('/login')} style={{ backgroundColor: '#f5a623', color: '#1a2e4a', border: 'none', padding: '15px 32px', borderRadius: 10, fontSize: 16, fontWeight: 800, cursor: 'pointer' }}>
                Create Account
              </button>
              <button className="btn-ghost" onClick={() => router.push('/login')} style={{ backgroundColor: 'transparent', color: '#fff', border: '2px solid rgba(255,255,255,0.65)', padding: '13px 32px', borderRadius: 10, fontSize: 16, fontWeight: 700, cursor: 'pointer' }}>
                Sign In
              </button>
            </div>
          </div>
        ...
        <div style={{ padding: '80px 24px', backgroundColor: '#ffffff' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto', textAlign: 'center' }}>
            <p style={{ color: '#f5a623', fontWeight: 700, fontSize: 11, letterSpacing: 3, textTransform: 'uppercase', marginBottom: 8 }}>What We Offer</p>
