...
<div key={stat.label} style={{ backgroundColor: '#060d1f', borderRadius: 10, padding: '10px 12px', textAlign: 'center' }}>
...
<button
onClick={() => whatsappCustomer(selected)}
style={{ width: '100%', padding: '13px', borderRadius: 12, backgroundColor: '#25d366', color: '#000', fontWeight: 'bold', border: 'none', fontSize: 15, cursor: 'pointer', marginBottom: 10 }}
>
...
<button
onClick={() => {
const subject = encodeURIComponent(`BSC Marketplace — Special offer for ${selected.name}`);
const body = encodeURIComponent(
`Hi ${selected.name},\n\nThank you for being a valued BSC Marketplace customer!\n\nWe have fresh seafood and products available. Visit us or order online:\nhttps://project-1fnu0.vercel.app/market\n\nFiretrial Road, Nassau, Bahamas\nWhatsApp: +1 (242) 359-0285\n\nFresh · Local · Bahamian 🐟`
);
window.open(`mailto:?subject=${subject}&body=${body}`, '_blank');
}}
style={{ width: '100%', padding: '13px', borderRadius: 12, backgroundColor: '#60a5fa', color: '#000', fontWeight: 'bold', border: 'none', fontSize: 15, cursor: 'pointer', marginBottom: 10 }}
>
📧 Send Email
</button>
...
style={{ width: '100%', padding: '13px', borderRadius: 12, backgroundColor: '#f5c518', color: '#000', fontWeight: 'bold', border: 'none', fontSize: 15, cursor: 'pointer', marginBottom: 10 }}
>
...
style={{ padding: '9px 14px', borderRadius: 10, backgroundColor: '#f5c518', color: '#000', fontWeight: 'bold', border: 'none', cursor: 'pointer', fontSize: 13 }}
>
🛒 POS
</button>
</div>
...
<div key={kpi.label} style={{ backgroundColor: '#0d1f3c', borderRadius: 12, padding: '10px 12px', border: '1px solid #1e3a5f', textAlign: 'center' }}>
...
style={{
padding: '7px 12px', borderRadius: 20, border: 'none', cursor: 'pointer', fontSize: 12, fontWeight: 'bold', whiteSpace: 'nowrap' as const,
backgroundColor: sortBy === opt.key ? '#f5c518' : '#0d1f3c',
color: sortBy === opt.key ? '#000' : '#6b7280',
}}
>
{opt.label}
</button>
