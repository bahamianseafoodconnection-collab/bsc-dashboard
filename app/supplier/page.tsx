...
export default function SupplierPage() {
  ...
  const WhatsAppSidebar = () => (
    <>
      <button onClick={() => setWaOpen(o => !o)} style={{ position: "fixed", bottom: 24, right: 18, zIndex: 300, width: 56, height: 56, borderRadius: "50%", backgroundColor: "#25d366", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 26, boxShadow: "0 4px 20px rgba(37,211,102,0.4)" }} title="Chat with BSC on WhatsApp">
        💬
      </button>
      {waOpen && (
            ...
            <div style={{ backgroundColor: "#0a1f0a", border: "1px solid #4ade80", borderRadius: 10, padding: "12px 14px", marginBottom: 12 }}>
              ...
              <div style={{ marginTop: 10, backgroundColor: "#060d1f", borderRadius: 8, padding: "8px 10px" }}>
                <p style={{ margin: 0, color: "#aaa", fontSize: 11 }}>
                  Based on <b style={{ color: "#fff" }}>{yieldIn} lbs in</b> → <b style={{ color: "#4ade80" }}>{yieldOut} lbs out</b> at <b style={{ color: "#f5c518" }}>${trueCostPerLb}/lb true cost</b>.
                </p>
              </div>
            </div>
          )}
  ...
  const ProductForm = ({ isEdit }: { isEdit: boolean }) => {
    ...
    return (
      <>
        ...
        {(prodCategory === "seafood" || prodCategory === "poultry" || prodCategory === "meat" ||
          prodCategory === "general" || prodCategory === "grocery" || prodCategory === "food" ||
          prodCategory === "electronics" || prodCategory === "baby" || prodCategory === "medical" ||
          prodCategory === "health" || prodCategory === "clothing" || prodCategory === "furniture" ||
          prodCategory === "alcohol") && (
          <>
                      ...
                      <div key={prod.id} style={{ backgroundColor: "#060d1f", borderRadius: 10, padding: "10px 12px", marginBottom: 8, border: "1px solid #1e2d4a" }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 6, marginBottom: prod.status === "pending" && !isOwnAccount ? 8 : 0 }}>
                          {[
                            ...
                            { l: "DUTY",      v: ((prod.duty_rate || 0) * 100).toFixed(0) + "%",     c: prod.duty_rate === 0 ? "#4ade80" : "#60a5fa" },
                          ].map(x => (
