...
function InvoiceContent() {
  ...
  if (loading)
    return (
      <div style={wrap}>
        <p style={{ color: "#555", textAlign: "center", paddingTop: 60 }}>
          Loading invoice...
        </p>
      </div>
    );
  ...
  if (!invoice)
    return (
      <div style={wrap}>
        <p style={{ color: "#f87171", textAlign: "center", paddingTop: 60 }}>
          Invoice not found
        </p>
      </div>
    );

  // Customer name may carry a "| delivery note" suffix from POS.
  ...
  return (
    <div style={wrap}>
      ...
      >
        <p style={{ margin: 0, fontWeight: "bold", fontSize: 16, color: "#111" }}>
          BSC MARKETPLACE
        </p>
        <p style={{ margin: "2px 0", fontSize: 11, color: "#666" }}>
      ...
      >
        <p style={{ margin: "2px 0", fontSize: 13, fontWeight: "bold", color: "#111" }}>
          {customerName}
        </p>
      ...
      {invoice.items.map((item, i) => (
        ...
        >
          <div>
            <p style={{ margin: 0, fontSize: 13, color: "#111", fontWeight: 500 }}>
              {item.productName}
            </p>
          ...
          <p style={{ margin: 0, fontSize: 13, fontWeight: "bold", color: "#111" }}>
      ...
      >
        ...
        <p style={{ margin: 0, fontWeight: "bold", fontSize: 18, color: "#111" }}>
      ...
      {/* ACTIONS — only on screen, hidden on print */}
