          ...
          {NAV_GROUPS.map((group) => (
            <div key={group.label} style={{ marginBottom: '8px' }}>
              ...
              {group.items.map((item) => (
                <Link key={item.label} href={item.href} onClick={() => { setSidebarOpen(false); if (item.href === '#ai') setActiveTab('ai'); }} style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '10px 20px', color: 'rgba(255,255,255,0.75)', fontSize: '14px', fontWeight: 500, textDecoration: 'none', transition: 'all 0.15s' }}>
                ...
                <div style={{ backgroundColor: '#fff', borderRadius: '16px', padding: '18px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', borderLeft: '5px solid #f4c842' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '12px' }}>
                    <div style={{ backgroundColor: '#fef9e7', borderRadius: '10px', padding: '10px' }}>
                      ...
                      <div style={{ color: '#1a2e5a', fontWeight: 900, fontSize: '18px' }}>$0.00</div>
                    </div>
                    <div style={{ backgroundColor: '#e8f5e9', borderRadius: '10px', padding: '10px' }}>
                      ...
                      <div style={{ color: '#2e7d32', fontWeight: 900, fontSize: '18px' }}>$0.00</div>
                    </div>
                  </div>
