...
export default function FounderDashboard() {
  ...
  const dashboards: { label: string; desc: string; href: string; icon: string }[] = [
    ...
    { label: 'Processor Live Feed',  desc: 'Every stage, real time + temp alerts', href: '/founder/processor-feed', icon: '📡' },
    ...
    { label: 'Supplier Applications',desc: 'Approve boat/farmer signups',      href: '/founder/supplier-applications', icon: '🎣' },
