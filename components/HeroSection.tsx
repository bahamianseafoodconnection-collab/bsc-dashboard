...
// UPDATED & POLISHED — Matches exact mockup image + master card brand
// Dark marble overlay option kept as fallback. Now uses vibrant seafood/meats hero for strong e-comm feel.

export default function HeroSection() {
return (
<section className="relative h-screen flex items-center bg-black overflow-hidden">
{/* Background image — seafood & meats (matches mockup) */}
<Image
